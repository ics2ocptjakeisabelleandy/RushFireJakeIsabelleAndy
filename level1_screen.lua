...
function scene:create( event )
    ...
    instructions5 = display.newText("you only lose a life", display.contentWidth/6.3, display.contentHeight/1.175, nil, 27)
    instructions6 = display.newText("if you fall off the screen!", display.contentWidth/6.3, display.contentHeight/1.125, nil, 27)
   ...
   --Insert the right arrow
    ...
    -- insert the portal
    portal = display.newImage("Images/Portal1.png", 100, 100)
